...
public class SubtractionOperation extends AbstractTwoArgumentsOperation {
	@Override
	public void process() {
		this.result = new BigDecimal(this.firstArgument.doubleValue(), STACK_MATH_CONTECT);
		this.result = this.result.subtract(this.secondArgument, STACK_MATH_CONTECT);
	}

	@Override
	public String getSymbol() {
		return SymbolConstants.SUBSTRACT;
	}
